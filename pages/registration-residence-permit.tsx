...
const DATA: IServiceData = {
  welcome: {
    ...
    titleID: 'registrationResidencePermit.welcome.title',
    button: {
      titleID: 'registrationResidencePermit.welcome.button.title',
      onClick: () => {}
    }
  },
  ...
  serviceRegistrationFAQData: Array.from({ length: 3 }, (_, index) => ({
    id: `${index}`,
    title: `registrationResidencePermit.serviceRegistrationFAQData.${index}.title`,
    content: `registrationResidencePermit.serviceRegistrationFAQData.${index}.content`
  }))
};

const RegistrationResidencePermitPage = () => <ServiceLayout type='WITHOUT_TABS' data={DATA} themeColor='#e9ce74' />;

export default RegistrationResidencePermitPage;
