...
import { DropdownRoot, DropdownBackground, AltBackground, InvertedDiv } from './views';
        ...
        <Flipped flipId='dropdown'>
          <DropdownBackground>
            <Flipped inverseFlipId='dropdown'>
              <InvertedDiv>
                <AltBackground ref={(el) => (this.altBackgroundEl = el)} duration={duration} />
                <FadeContents direction={direction} duration={duration} ref={this.currentDropdownEl}>
                  {currentDropdown}
                </FadeContents>
              </InvertedDiv>
            </Flipped>
            ...
            <Flipped inverseFlipId='dropdown' scale>
              <InvertedDiv absolute>
                {prevDropdown && (
                  <FadeContents animatingOut direction={direction} duration={duration} ref={this.prevDropdownEl}>
                    {prevDropdown}
                  </FadeContents>
                )}
              </InvertedDiv>
