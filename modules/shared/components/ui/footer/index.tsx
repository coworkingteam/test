  ...
  return (
    <Wrapper>
      <ContentWrapper>
        ...
        <FAQWrapper>
          to firma, której branża została w Polskiej Klasyfikacji Działalności (PKD) sklasyfikowana jako: Działalność
          związana z wyszukiwaniem miejsc pracy i pozyskiwaniem pracowników. Powstała w 2021 roku. Forma prawna firmy
          BAGHEERA (R&K GROUP) SP. Z O.O. to Spółka z ograniczoną odpowiedzialnością. Firma posiada numer NIP
          7822895535, numer REGON 388431682 i KRS 0000889522, a jej siedziba mieści się pod adresem: Ul. Stanisława
          Małachowskiego 8/PI, 61-129 w Poznaniu, województwo Wielkopolskie. Z firmą BAGHEERA (R&K GROUP) SP. Z O.O.
          skontaktujesz się telefonicznie pod numerem +48 728 000 702. Odwiedź stronę internetową firmy BAGHEERA (R&K
