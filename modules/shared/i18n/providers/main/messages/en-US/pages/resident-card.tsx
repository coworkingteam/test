  ...
  serviceRegistrationFAQData: [
    ...
    },
    {
      ...
      content:
        ...
        '\n' +
        'The second and most common reason for delays is the request for additional documents/references/translations. It can take from 2 to 3 weeks from the inspector’s request to delivering a document fulfilling it\n' +
